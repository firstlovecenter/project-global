...
const SearchCity = (props: RoleBasedSearch) => {
  ...
  const citySearch = async ({
    ...
    try {
      setLoading(true)
      const fetchUrl = new URL(SEARCH_FUNCTION_BASE_URL + '/city')
      ...
      toast({
        ...
        description: 'There was an error searching for city ' + error,
        status: 'error',
        duration: 6000,
        isClosable: true,
      })
  ...
  useEffect(() => {
    // Function to perform the city search
